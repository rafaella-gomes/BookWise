/*
  ...
  - Added the required column `provideAccountId` to the `accounts` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_accounts" (
    ...
    "provideAccountId" TEXT NOT NULL,
    "refresh_token" TEXT,
    "access_token" TEXT,
    "expires_at" INTEGER,
    "token_type" TEXT,
...
CREATE UNIQUE INDEX "accounts_provider_provideAccountId_key" ON "accounts"("provider", "provideAccountId");
